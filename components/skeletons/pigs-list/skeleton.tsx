...
import { Heart, Calendar, TrendingUp, Users, Crown } from "lucide-react";
import { PigListSkeletonProps } from "@/types";

const PigListSkeleton: React.FC<PigListSkeletonProps> = ({ farmId }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-4 sm:p-6 shadow-sm border border-gray-100 dark:border-gray-800">
        <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* Stats Cards Skeleton - Matching pig-list structure */}
          <div className="grid grid-cols-2 gap-2 lg:grid-cols-4 lg:gap-2">
            {[TrendingUp, Heart, Crown, Users].map((Icon, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-3 sm:p-4 min-w-[90px] sm:min-w-[120px]"
              >
                <div className="flex items-center gap-1 sm:gap-2 mb-1">
                  <Icon className="h-3 w-3 sm:h-4 sm:w-4 text-blue-600 dark:text-blue-400" />
...
export default PigListSkeleton;
